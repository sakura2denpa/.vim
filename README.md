...
My vim dot files, grabbed originally from [jfrazelle's vim dot](https://github.com/jfrazelle/.vim.git .vim) files.

The `.vimrc` file is saved to [vimrc](https://github.com/sakura2denpa/.vim/blob/master/vimrc).

Just run the following commands via terminal to get perfectly set up:

```console
$ cd ~/
$ git clone --recursive https://github.com/sakura2denpa/.vim.git .vim
